...
{
    QString CSS = "body {font-size:12px; color:#f8f6f6; bgcolor:#e69e37;}\n a, span { font-family: monospace; }\n span.addr {color:#e69e37; font-weight: bold;}\n table tr td {padding: 3px; border: 1px solid black; background-color: #e69e37;}\n td.d0 {font-weight: bold; color:#f8f6f6;}\n h2, h3 { white-space:nowrap; color:#e05337;}\n a { color:#F6E8D4; text-decoration:none; }\n a.nav {color:#A00A21;}\n";
