                                                                                                            ...
                                                                                                            fCapsLock(false)
{
    ...
    if (context == Context::Unlock_Menu || context == Context::Mint_zbit || context == Context::BIP_38) {
    ...
    // It doesn't make sense to show the checkbox for sending BIT because you wouldn't check it anyway.
    if (context == Context::Send_PIV || context == Context::Send_zbit) {
