...
static void NotifyzbitReset(WalletModel* walletmodel)
{
    qDebug() << "NotifyzbitReset";
...
void WalletModel::subscribeToCoreSignals()
{
    ...
    wallet->NotifyzbitReset.connect(boost::bind(NotifyzbitReset, this));
...
void WalletModel::unsubscribeFromCoreSignals()
{
    ...
    wallet->NotifyzbitReset.disconnect(boost::bind(NotifyzbitReset, this));
...
{
    setMints.clear();
    setMints = pwalletMain->zbitTracker->ListMints(fUnusedOnly, fMaturedOnly, fUpdateStatus);
}
