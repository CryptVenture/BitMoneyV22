                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzbitPathCustom = GetArg("-zbitbackuppath", "");
    ...
    if(!strzbitPathCustom.empty()) {
        ui->wallet_customzbitbackuppath->setText(QString::fromStdString(strzbitPathCustom));
        ui->wallet_customzbitbackuppath_label->setVisible(true);
        ui->wallet_customzbitbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzbitPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the BitMoney RPC console.") + "<br>" +
