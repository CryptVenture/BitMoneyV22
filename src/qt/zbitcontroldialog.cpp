...
std::set<std::string> zbitControlDialog::setSelectedMints;
std::set<CMintMeta> zbitControlDialog::setMints;

bool CzbitControlWidgetItem::operator<(const QTreeWidgetItem &other) const {
    int column = treeWidget()->sortColumn();
    if (column == zbitControlDialog::COLUMN_DENOMINATION || column == zbitControlDialog::COLUMN_VERSION || column == zbitControlDialog::COLUMN_CONFIRMATIONS)
...
void zbitControlDialog::updateList()
{
    ...
    for (auto denom : libzerocoin::zerocoinDenomList) {
        CzbitControlWidgetItem* itemDenom(new CzbitControlWidgetItem);
    ...
    for (const CMintMeta& mint : setMints) {
        ...
        CzbitControlWidgetItem *itemMint = new CzbitControlWidgetItem(ui->treeWidget->topLevelItem(mapDenomPosition.at(denom)));
...
void zbitControlDialog::updateLabels()
{
    ...
    privacyDialog->setzbitControlLabels(nAmount, setSelectedMints.size());
}

std::vector<CMintMeta> zbitControlDialog::GetSelectedMints()
{
