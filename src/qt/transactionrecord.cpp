...
QList<TransactionRecord> TransactionRecord::decomposeTransaction(const CWallet* wallet, const CWalletTx& wtx)
{
    ...
    if (wtx.IsCoinStake()) {
        ...
        if (wtx.IsZerocoinSpend() && (fZSpendFromMe || wallet->zbitTracker->HasMintTx(hash))) {
            //zBIT stake reward
            sub.involvesWatchAddress = false;
            sub.type = TransactionRecord::Stakezbit;
...
bool IszbitType(TransactionRecord::Type type)
{
    switch (type) {
        case TransactionRecord::Stakezbit:
...
void TransactionRecord::updateStatus(const CWalletTx& wtx)
{
    ...
    else if (type == TransactionRecord::Generated || type == TransactionRecord::StakeMint || type == TransactionRecord::Stakezbit || type == TransactionRecord::MNReward) {
