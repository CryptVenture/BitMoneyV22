...
enum AvailableCoinsType {
    ...
    ONLY_DENOMINATED = 2,
    ONLY_NOT10000IFMN = 3,
    ONLY_NONDENOMINATED_NOT10000IFMN = 4, // ONLY_NONDENOMINATED and not 10000 BIT at the same time
...
enum ZerocoinSpendStatus {
    ...
    zbit_TX_TOO_LARGE = 15,                          // The transaction is larger than the max tx size
    zbit_SPEND_V1_SEC_LEVEL                         // Spend is V1 and security level is not set to 100
};
...
public:
    ...
    bool CreatezbitOutPut(libzerocoin::CoinDenomination denomination, CTxOut& outMint, CDeterministicMint& dMint);
    bool GetMint(const uint256& hashSerial, CZerocoinMint& mint);
    bool GetMintFromStakeHash(const uint256& hashStake, CZerocoinMint& mint);
    bool DatabaseMint(CDeterministicMint& dMint);
    bool SetMintUnspent(const CBigNum& bnSerial);
    bool UpdateMint(const CBigNum& bnValue, const int& nHeight, const uint256& txid, const libzerocoin::CoinDenomination& denom);
    string GetUniqueWalletBackupName(bool fzbitAuto) const;
    ...
    */
    ...
    CzbitWallet* zwalletMain;

    bool fFileBacked;
    bool fWalletUnlockAnonymizeOnly;
    std::string strWalletFile;
    bool fBackupMints;
    std::unique_ptr<CzbitTracker> zbitTracker;
    ...
    void setZWallet(CzbitWallet* zwallet)
    {
        zwalletMain = zwallet;
        zbitTracker = std::unique_ptr<CzbitTracker>(new CzbitTracker(strWalletFile));
    }

    CzbitWallet* getZWallet() { return zwalletMain; }
    ...
    /** zBIT reset */
    boost::signals2::signal<void()> NotifyzbitReset;
