...
extern UniValue setzbitseed(const UniValue& params, bool fHelp);
extern UniValue getzbitseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzbit(const UniValue& params, bool fHelp);
extern UniValue dzbitstate(const UniValue& params, bool fHelp);
