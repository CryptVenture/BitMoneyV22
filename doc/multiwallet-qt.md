...
In order to support loading of multiple wallets in BitMoney-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is BitMoney.cpp.
...
Changes to BitMoney.cpp
----------------------
BitMoney.cpp is the entry point into BitMoney-qt, and as such, will require some minor modifications to provide hooks for
