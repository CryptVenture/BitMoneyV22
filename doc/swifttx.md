...
This mechanism has been integrated into Bitcore-Node-BitMoney which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/BitMoney-Project/insight-api-BitMoney#web-socket-api](https://github.com/BitMoney-Project/insight-api-BitMoney#web-socket-api) 
* API: [https://github.com/BitMoney-Project/insight-api-BitMoney#swifttx-transactions](https://github.com/BitMoney-Project/insight-api-BitMoney#swifttx-transactions) 
...
By default, the BitMoney Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the BitMoney Core daemon:
